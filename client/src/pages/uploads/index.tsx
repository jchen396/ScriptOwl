    ...
    return (
        <>
            <div className="w-full h-full bg-black flex flex-col justify-center items-center text-white space-y-10 py-10">
                ...
                {showEditMsg && (
                    <div className="w-1/5 h-1/3 absolute flex flex-col justify-center items-center p-4 rounded-lg text-white border-2 border-white bg-black z-50">
                        {editSuccess && (
                            <div className="bg-green-500 p-4 rounded flex flex-row justify-between items-center space-x-2">
                                ...
                                <span className="text-black ">
                                    Video details changed successfully!
                                </span>
                                <CloseIcon
